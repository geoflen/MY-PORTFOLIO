    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl leading-[1.15] font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">
            Geoffrey Anguyo
          </h1>
      ...
      <footer className="py-8 px-6 border-t border-slate-800 bg-slate-900">
        <div className="max-w-6xl mx-auto text-center text-slate-400">
          <p>© 2024 Geoffrey Anguyo. Building useful things with data, code, and a little curiosity.</p>
        </div>
      </footer>
